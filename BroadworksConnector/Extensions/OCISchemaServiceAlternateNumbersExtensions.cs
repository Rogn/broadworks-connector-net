...
namespace BroadWorksConnector
{
    public static class OCISchemaServiceAlternateNumbersExtensions
    {
        ...
        public static async Task<UserAlternateNumbersGetResponse21> UserAlternateNumbersGetRequest21(this OcipClientBase client, UserAlternateNumbersGetRequest21 request)
        {
        ...
        /// The response is either a UserAlternateNumbersGetResponse21 or an ErrorResponse.
        /// </summary>
        public static async Task<UserAlternateNumbersGetResponse21> UserAlternateNumbersGetRequest21Async(this OcipClientBase client, UserAlternateNumbersGetRequest21 request, CancellationToken cancellationToken = default)
        {
        ...
        public static async Task<SuccessResponse> UserAlternateNumbersModifyRequest(this OcipClientBase client, UserAlternateNumbersModifyRequest request)
        {
        ...
        /// The response is either a SuccessResponse or an ErrorResponse.
        /// </summary>
        public static async Task<SuccessResponse> UserAlternateNumbersModifyRequestAsync(this OcipClientBase client, UserAlternateNumbersModifyRequest request, CancellationToken cancellationToken = default)
        {
