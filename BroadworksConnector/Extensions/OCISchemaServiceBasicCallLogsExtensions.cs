...
namespace BroadWorksConnector
{
    public static class OCISchemaServiceBasicCallLogsExtensions
    {
        ...
        public static async Task<UserBasicCallLogsGetListResponse14sp4> UserBasicCallLogsGetListRequest14sp4(this OcipClientBase client, UserBasicCallLogsGetListRequest14sp4 request)
        {
        ...
        /// The response is either a UserBasicCallLogsGetListResponse14sp4 or an ErrorResponse.
        /// </summary>
        public static async Task<UserBasicCallLogsGetListResponse14sp4> UserBasicCallLogsGetListRequest14sp4Async(this OcipClientBase client, UserBasicCallLogsGetListRequest14sp4 request, CancellationToken cancellationToken = default)
        {
