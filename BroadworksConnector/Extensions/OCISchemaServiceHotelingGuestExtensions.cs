...
namespace BroadWorksConnector
{
    public static class OCISchemaServiceHotelingGuestExtensions
    {
        ...
        public static async Task<UserHotelingGuestGetAvailableUserListResponse> UserHotelingGuestGetAvailableUserListRequest(this OcipClientBase client, UserHotelingGuestGetAvailableUserListRequest request)
        {
        ...
        /// The response is either UserHotelingGuestGetAvailableUserListResponse or ErrorResponse.
        /// </summary>
        public static async Task<UserHotelingGuestGetAvailableUserListResponse> UserHotelingGuestGetAvailableUserListRequestAsync(this OcipClientBase client, UserHotelingGuestGetAvailableUserListRequest request, CancellationToken cancellationToken = default)
        {
        ...
        public static async Task<UserHotelingGuestGetResponse14sp4> UserHotelingGuestGetRequest14sp4(this OcipClientBase client, UserHotelingGuestGetRequest14sp4 request)
        {
        ...
        /// The response is either a UserHotelingGuestGetResponse14sp4 or an ErrorResponse.
        /// </summary>
        public static async Task<UserHotelingGuestGetResponse14sp4> UserHotelingGuestGetRequest14sp4Async(this OcipClientBase client, UserHotelingGuestGetRequest14sp4 request, CancellationToken cancellationToken = default)
        {
        ...
        public static async Task<SuccessResponse> UserHotelingGuestModifyRequest21(this OcipClientBase client, UserHotelingGuestModifyRequest21 request)
        {
        ...
        /// The response is either a SuccessResponse or an ErrorResponse.
        /// </summary>
        public static async Task<SuccessResponse> UserHotelingGuestModifyRequest21Async(this OcipClientBase client, UserHotelingGuestModifyRequest21 request, CancellationToken cancellationToken = default)
        {
